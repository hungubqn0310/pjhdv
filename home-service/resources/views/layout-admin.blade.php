                ...
                <div class="leftside-navigation">
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{URL ::to('/add-discount')}}">Thêm mã giảm giá</a></li>
                                <li><a href="{{URL ::to('/all-discount')}}">Danh sách mã giảm giá</a></li>
                            </ul>
                        </li>
                    </ul>            
                </div>
        ...
        <section id="main-content">
            ...
            <div class="footer" style="text-align: center;">
                <div class="wthree-copyright">
                    <p>Copyright © 2024 website đồ án phát triển phần mềm hướng dịch vụ</p>
                </div>
            </div> <!--footer end -->
